...
public class ShineLessonMock {
    ...
    public static ArrayList<ShineLessonModel> getMockShineLessons() {
        ...
        mockShineLessonModel.add(new ShineLessonModel("Meditação contra Ansiedade", "R$ 10,00", "https://img.freepik.com/fotos-gratis/mulher-de-alto-angulo-meditando-em-casa_23-2150404951.jpg", 1)); // para o usuário test
        mockShineLessonModel.add(new ShineLessonModel("Workshop Montagem de PCs Gamers", "R$ 50,00", "https://img-b.udemycdn.com/course/480x270/4006556_6a5a_6.jpg", 1)); // usuário teste tambem 
